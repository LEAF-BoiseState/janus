...
extent_poly.to_file(DataPath+'ABMdev/Data/extent_3km_AdaCanyon.shp')
np.save(DataPath+'ABMdev/Data/gcam_3km_2010_AdaCanyon.npy', gcam_init) #not sure if this one needs to be changed ...
