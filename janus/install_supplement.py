...
class InstallSupplement:
    ...
    # TODO:  replace link with actual data once it has been archived
    DATA_VERSION_URLS = {'0.0.1': 'https://zenodo.org/record/2578287/files/example.zip?download=1'}
    ...
    def fetch_zenodo(self):
        ...
        print("Downloading example data for version {}".format(current_version))
